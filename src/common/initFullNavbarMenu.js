...
const initFullNavbarMenu = () => {
  let open = false;
  const navDark = document.querySelector('.topnav.dark');
  const logoChan = document.querySelector('.topnav.dark .logo img');
  ...
  if (menuIcon) {
    menuIcon.addEventListener('click', () => {
      ...
      if (open) {
        ...
        document.querySelector('.topnav .menu-icon .text');
