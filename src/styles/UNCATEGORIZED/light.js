...
export const UNCATEGORIZED_Light = css`
  /*-----------------------------------------------------------------------------------
...
---------------------------------------------------------------- */
  ...
  .butn.dark {
    background: ${({ theme }) => theme.colors.mine_shaft_dark};
    color: ${({ theme }) => theme.colors.white};
  }

  .butn.dark:hover {
    background: transparent;
    border-color: ${({ theme }) => theme.colors.mine_shaft_dark};
    color: ${({ theme }) => theme.colors.mine_shaft};
  }
  ...
  .nav-scroll {
    background: ${({ theme }) => theme.colors.white};
    border-color: ${({ theme }) => theme.colors.wild_sand};
    padding: 0;
    position: fixed;
    top: -80px;
  ...
  .topnav.light .icon i {
    background: ${({ theme }) => theme.colors.cod_gray} !important;
  }
  ...
  .freelancre .states .mail-us .icon-box {
    ...
    background: -webkit-linear-gradient(
      323.53deg,
      ${({ theme }) => theme.colors.gallery} 6.69%,
  ...
  .next-prog .box .copy-cap h1 .stroke {
    display: inline-block;
    color: transparent;
    -webkit-text-stroke: 1px ${({ theme }) => theme.colors.cod_gray};
  }
  ...
  .testimonials .item {
    ...
    background: -webkit-linear-gradient(
      323.53deg,
      ${({ theme }) => theme.colors.silver} 6.69%,
      rgba(2, 2, 30, 0) 85.43%
    );
    background: -o-linear-gradient(
      323.53deg,
  ...
  .testimonials .item .info .img {
    width: 80px;
    height: 80px;
    border: 7px solid ${({ theme }) => theme.colors.gallery};
    border-radius: 50%;
    overflow: hidden;
    margin-bottom: 20px;
  }
  ...
  .blog-grid .item.list .cont .date {
    ...
    padding: 5px 15px;
    background: ${({ theme }) => theme.colors.bright_turquoise};
    color: ${({ theme }) => theme.colors.mine_shaft_dark};
    font-size: 12px;
    font-weight: 500;
    text-align: center;
    z-index: 2;
